...
const (
	UserService_Register_FullMethodName   = "/user.service.v1.UserService/Register"
...
type UserServiceClient interface {
	...
	// Delete user
	DeleteUser(ctx context.Context, in *UserRequest, opts ...grpc.CallOption) (*DeleteReply, error)
	// List all users
...
func (c *userServiceClient) DeleteUser(ctx context.Context, in *UserRequest, opts ...grpc.CallOption) (*DeleteReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(DeleteReply)
...
func (UnimplementedUserServiceServer) UpdateUser(context.Context, *UpdateUserRequest) (*UserReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateUser not implemented")
}
func (UnimplementedUserServiceServer) DeleteUser(context.Context, *UserRequest) (*DeleteReply, error) {
...
var UserService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "kratos/api/user/service/v1/user.proto",
}
